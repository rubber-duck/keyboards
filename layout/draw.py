...
The printable cheatsheet is an imagegen snapshot at keymap-drawer/cheatsheet.png.
"""
...
def render():
    lines = [
        ...
        "# Cheatsheet: keymap-drawer/cheatsheet.png (imagegen snapshot; update after layout changes).",
        "layout:",
